var _0x3bf9 = ['AB8', 'ABGroup', 'nameCache', 'getNameSize', 'setSize', 'getNumPoints', 'flag', 'retrieve2', 'ref', 'cos', 'wasSimpleDrawing', 'drawTime', 'miter', '#AAAAAA', 'closePath', 'http://opnagar.us/skinlist/', '.png', 'complete', 'http://www.pngall.com/wp-content/uploads/2016/05/Trollface-PNG.png', 'clip', 'ceil', 'setScale', 'sizeCache', '_size', '_scale', '_dirty', '_value', '_canvas', '_ctx', 'px Ubuntu', 'strokeText', 'getTime', 'depth', 'items', 'maxChildren', 'maxDepth', 'findOverlappingNodes', 'exists', 'retrieve', 'devide', 'minX', 'minY', 'root', 'onload', 'mes', 'focus', 'onmousemove', 'addEventListener', 'touchstart', 'onmouseup', 'DOMMouseScroll', 'body', 'onmousewheel', 'onfocus', 'onblur', 'chat_textbox', 'inspect', 'onkeydown', 'keyCode', 'E pressed', 'R pressed', 'blur', 'onkeyup', 'onresize', 'e at 204', 'ready', 'Enter server address:port', 'pathname', 'location', 'server', 'asqwr', 'join', ' not found!', 'ERR: Couldnt contact servers', 'search', 'method', '://', 'jQuery', 'defineProperty', 'function', 'defineProperties', 'get', 'set', 'prototype', 'value', 'getGlobal', 'undefined', 'global', 'polyfill', 'split', 'length', 'Array.prototype.fill', 'max', 'es6-impl', 'es3', 'cells', 'hashmap', 'changedTouches', 'clientX', 'identifier', 'reset', 'clientY', 'touches', 'preventDefault', 'copyFrom', 'minusEq', 'pow', 'wheelDelta', 'detail', 'POSITIVE_INFINITY', 'NEGATIVE_INFINITY', 'shouldRender', 'prepareData', 'size', 'min', 'init', 'points', 'insert', 'hide', '#adsBottom', '#overlays', 'fadeIn', 'leavemessage', 'bind', 'beforeunload', 'title', 'prop', 'text', '#titleh', 'defaultusername', 'val', 'nickplaceholder', 'attr', '#nick', 'instructions', '#customins', 'customHTML', '#customht', 'html', 'maxName', 'maxlength', 'wMacro', 'sMacro', 'eMacro', 'rMacro', 'qMacro', 'chat', 'show', 'darkBG', 'skins', 'grid', 'acid', 'colors', 'names', 'showMass', 'smooth', '#cchat', 'disabled', '#cdark', '#cskin', '#cgrid', '#cacid', '#ccolor', '#cname', '#csmooth', 'abs', 'mouse', 'charAt', 'indexOf', 'substring', 'toLowerCase', 'substr', 'emit', 'play', 'name', 'skin', 'requestAnimationFrame', 'scrollTo', 'innerWidth', 'innerHeight', 'width', 'height', 'css', 'transform', 'none', 'translate(-50%, -50%) scale(', 'translate(-50%, -50%)', 'sin', 'atan2', 'src', 'drawImage', 'now', 'updatePos', 'clearRect', 'fillStyle', '#111111', '#F2FBFF', 'globalAlpha', 'fillRect', 'sort', 'save', 'translate', 'scale', 'drawOneCell', '#FFAAAA', 'lineWidth', 'lineCap', 'lineJoin', 'moveTo', 'lineTo', 'stroke', 'restore', '#FFFFFF', 'setValue', 'Score: ', 'render', '#000000', 'beginPath', 'strokeStyle', '#0096ff', 'arc', 'mass', 'color', 'pointsAcc', 'createPoints', 'setName', '_color', '_stroke', '_strokeColor', 'closeButton', 'options', 'preventDuplicates', 'progressBar', 'newestOnTop', 'positionClass', 'http://opnagar.us/skinlist.php', 'GET', 'toString', 'success', 'Skins loaded', 'error', 'createTouch', 'index', 'buffer', 'readString8', 'byteLength', 'readUInt8', 'fromCharCode', 'readString16', 'readUInt16BE', 'readString32', 'readUInt32BE', 'readInt8', 'getInt8', 'getUint8', 'readInt16BE', 'getInt16', 'readInt16LE', 'getUint16', 'readUInt16LE', 'readInt32BE', 'getInt32', 'readInt32LE', 'getUint32', 'readUInt32LE', 'addNode', 'push', 'removeNode', 'splice', 'calcCenter', 'API', '_commandLineAPI', '_inspectorCommandLineAPI', 'clear', 'Control your cell using the mouse, w for eject, space for split. Add &lt;skinname&gt; in your username for skins.', 'Leaderboard', '20px Ubuntu', '#333333', '#FF3333', '#33FF33', '#3333FF', 'ontouchstart', 'test', 'userAgent', 'split.png', 'feed.png', 'canvas', 'isSpectating', 'setNick', 'log', 'setSkins', 'setNames', 'setDarkTheme', 'setShowMass', 'setHideGrid', 'setSmooth', 'setHideChat', '#chat_textbox', 'spectate', 'setGameMode', 'cha', 'setAcid', 'connect', 'charCodeAt', 'owd2du2edws38fhjsj', 'floor', 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=', 'slice', 'random', 'onopen', 'onmessage', 'onclose', 'close', 'info', 'Connecting to server...', 'Connecting to ', 'ERROR: Connection error!', 'ERROR: Reconnect error!', 'reconnect_failed', 'warning', 'disconnect', 'Socket Close', 'Socket closed. Disconnected from server', '#connecting', 'hello', 'replace', 'version', '4.0.0', '#kicked', 'Server is outdated! Please upgrade to version 4.0.0', 'Could not connect to server. Reason:', 'secure', 'key', 'suid', 'ajax', 'http://live.ogarul.io', 'POST', 'Server is not active!', 'Couldnt verify server', 'Server could not be verified. It might have been a mock-server!', '#denied', 'uid', '#kmsg', 'Server not secure!', 'The official client requires secure connections. This server has secure connections off. Please alert the server owner.', 'infop', 'empty', 'append', '#gamemode', '<option></option>', 'Players: ', 'players', '\x0aBots: ', 'bots', 'scn', 'Connected!', 'kicked', 'ddos', 'Server is being DDOSed! Stopping all requests until over.', 'The server is being DDOSed. So the server is paused. The server will unpause and this message will dissapear after the attack is over', 'Server DDOSED!', 'type', 'showOverlay', 'bounds', 'setScore', 'score', 'setPid', 'pid', 'setFPS', 'fps', 'updatepos', 'cpacket', 'rip', 'alive', 'killerId', 'round', ' minutes and ', 'killer', 'nodes', 'hasOwnProperty', 'updateId', 'oSize', 'nSize', 'updateCode', 'updateTime', 'destroyed', 'destroy', 'ownerId', 'isVirus', 'isAgitated', 'display', 'style', 'getElementById', 'overlays', 'delnodes', 'parse', 'conf', 'teamColors', 'lbtop', 'lbfsty', 'lbtsty', 'lbtype', 'lbfont', 'createElement', 'getContext', 'font', '30px Ubuntu', 'measureText', 'An unnamed cell', 'scolor', 'fillText', 'fill', 'remove', 'msg', 'time', 'exp', 'getWidth', '#666666', 'message', 'localStorage'];
(function(B, bp) {
    var bq = function(a) {
        while (--a) {
            B['push'](B['shift']())
...
(function(n, j) {
    ...
    toastr[_2afa('0x98')][_2afa('0x97')] = true;
    toastr[_2afa('0x98')][_2afa('0x99')] = true;
    toastr[_2afa('0x98')][_2afa('0x9a')] = true;
    toastr[_2afa('0x98')][_2afa('0x9b')] = false;
    toastr[_2afa('0x98')][_2afa('0x9c')] = 'toast-bottom-right';
    var bc = false
      , L = []
      , bU = false
      , bD = 0x0
    ...
    var bC = false
      , bV = 0x78
      , bj = -0x1
      , bk = _2afa('0xa3')in document
      , W = []
      , P = -0x1
      , V = new Vector2(0x0,0x0)
      , M = new Vector2(0x0,0x0)
      , Q = new Vector2(0x0,0x0)
      , bW = 0x0
      , bb = false
      , z = function(a) {
        this[_2afa('0xa4')] = 0x0;
    ...
    ;
    console[_2afa('0xc0')];
    _2afa('0x8') !== typeof console[_2afa('0xc1')] ? console['API'] = console[_2afa('0xc1')] : _2afa('0x8') !== typeof console[_2afa('0xc2')] ? console[_2afa('0xc0')] = console[_2afa('0xc2')] : _2afa('0x8') !== typeof console[_2afa('0xc3')] && (console[_2afa('0xc0')] = console);
    ...
    }, Z = false, bx = false, cn = [], by = 0.4, bS = false, N = x = ~~((bl + bn) / 2), _0x43bf16 = y = ~~((bm + bo) / 2), _276e5e = 0x1, _0x42c0b5 = '', _0x40f9e6 = true, _0x3549b8 = false, _0x1d1331 = 0x0, _0x1ab7d8 = 0x0, _2ebfc7 = 0x0, _0x1b6faf = 0x0, _0x3af78a = 0x0, _0x5f1470 = _2afa('0xc5'), _0xa9064e = 0x0, _2332ea = _2afa('0xc6'), _0xda1180 = _2afa('0x8a'), _0x5be15e = _2afa('0x86'), _24f95e = [_2afa('0xc7'), _2afa('0xc8'), _2afa('0xc9'), _2afa('0xca')], _0x12425e = false, _0x3f6cb1 = 0x1;
    _2afa('0xcb')in n && /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i['test'](navigator['userAgent']);
    var _0x16c472 = new Image()
      , _0x57e636 = new Image();
    _0x16c472[_2afa('0x6f')] = _2afa('0xce');
    _0x57e636['src'] = _2afa('0xcf');
    document['createElement'](_2afa('0xd0'));
    n[_2afa('0xd1')] = false;
    n[_2afa('0xd2')] = function(a) {
        bJ();
        Y = a;
    ...
    n[_2afa('0xe0')] = function(bX, cq) {
        function co(h) {
            ...
            return function(a) {
                ...
                while (e < a.length);a = a.length % 0x3;
        ...
        m['on'](_2afa('0x126'), function(a) {
            ...
            a = b / 0x3e8 / 0x3c << 0x0;
            b = b / 0x3e8 % 0x3c;
            j('#alive')['text']('You've been alive for ' + Math[_2afa('0x129')](a) + _2afa('0x12a') + Math[_2afa('0x129')](b) + ' seconds!');
            setTimeout(function() {
                bt(false)
            }, 0x3e8)
        });
